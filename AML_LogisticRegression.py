...
# Add the Logistic Regression model to the pipeline stages
...
logging.info("***********TrainValidator-Results-LR************")
...
# COMMAND ----------
#Comment this while running TrainValidationSplit and vice versa
...
logging.info("***********CrossValidator-Results-LR************")
